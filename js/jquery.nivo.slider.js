...
(function($) {
    var NivoSlider = function(element, options){
        ...
        if(settings.directionNav){
			...
			slider.append('<div class="numbers">' + "фото " + i + " из " + kids.length + '</div>');
			$(".nivo-prevNav").css("visibility","hidden");
            ...
            $('a.nivo-prevNav', slider).live('click', function(){
				...
				i--;
				$('.numbers').replaceWith('<div class="numbers">' + "фото " + i + " из " + kids.length + '</div>');
				$(".nivo-nextNav").css("visibility","visible");										
				if (i == 1){
					$(".nivo-prevNav").css("visibility","hidden");
					$(".nivo-nextNav").css("visibility","visible");
				}
				
				console.log('текущий слайд ', vars.currentSlide);				
			    //$('img').click(function(){
            ...
            $('a.nivo-nextNav', slider).live('click', function(){
				...
				i++;
				$('.numbers').replaceWith('<div class="numbers">' + "фото " + i + " из " + kids.length + '</div>');
				$(".nivo-prevNav").css("visibility","visible");
				
				if (i == kids.length){
					$(".nivo-nextNav").css("visibility","hidden");
				}
				//cookie.set("current_slide", i);
				//console.log('i при нажатии на next: ', i);
				//console.log('текущий слайд ', vars.currentSlide);
			    //$('img').click(function(){
				//if(vars.currentSlide == 1){
			...
			$(".img1").click(function(){
			//if(vars.currentSlide == 1){
			console.log('щелчок по картинке ', vars.currentSlide);
			//alert("");
			});
			
			console.log('i после if: ', i);
			//vars.controlNavEl.append('<div class="nivo-control">'+  (i + 1) + " из " + kids.length + '</div>');
		}
		...
		function doZoom(img, link){
			console.log('Выполняется doZoom');
		...
		function loadImg(img, link, callback){
			console.log('Выполняется loadImg');
			//Load large image
			...
			}).attr('src','images/monstersinc_large.jpg');
		}
		*/
		...
		function loadImg(){
			...
			$('newImg').animate({ opacity:0 }, settings.speed/2, function(){
					imgLarge.fadeIn(settings.speed/2, function(){
				});
			});
		}		
